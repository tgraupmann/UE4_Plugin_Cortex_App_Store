...
namespace tv_ouya_console_api_content_OuyaModEditor
{
	...
	const OuyaModEditor OuyaModEditor::CreateObject(jobject instance)
	{
		OuyaModEditor ouyaModEditor;
		ouyaModEditor._instance = instance;
		return ouyaModEditor;
	}
	...
	OuyaModScreenshot OuyaModEditor::addScreenshot(const Bitmap& bitmap) const
	{
		...
		return OuyaModScreenshot::CreateObject(globalRef);
	}
