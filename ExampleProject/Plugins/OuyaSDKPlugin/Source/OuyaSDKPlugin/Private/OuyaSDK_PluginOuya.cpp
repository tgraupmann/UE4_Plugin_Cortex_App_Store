...
namespace OuyaSDK
{
	...
	void PluginOuya::contentDelete(const OuyaMod& ouyaMod, CallbacksContentDelete* callbacks)
	{
	...
	void PluginOuya::contentDownload(const OuyaMod& ouyaMod, CallbacksContentDownload* callbacks)
	{
	...
	void PluginOuya::contentPublish(const OuyaMod& ouyaMod, CallbacksContentPublish* callbacks)
	{
	...
	void PluginOuya::contentUnpublish(const OuyaMod& ouyaMod, CallbacksContentUnpublish* callbacks)
	{
	...
	void PluginOuya::saveOuyaMod(const tv_ouya_console_api_content_OuyaModEditor::OuyaModEditor& ouyaModEditor,
		const OuyaMod& ouyaMod,
	...
	vector<OuyaModScreenshot> PluginOuya::getOuyaModScreenshotArray(jobject listOuyaModScreenshots)
	{
		...
		for (jsize index(0); index < length; ++index)
		{
			...
			jobject globalRef = (jobject)env->NewGlobalRef(localRef);
			env->DeleteLocalRef(localRef);
			OuyaModScreenshot ouyaModScreenshot = OuyaModScreenshot::CreateObject(globalRef);
