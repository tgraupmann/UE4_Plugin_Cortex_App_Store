...
namespace tv_ouya_console_api_content_OuyaMod
{
	...
	const OuyaMod OuyaMod::CreateObject(jobject instance)
	{
		OuyaMod ouyaMod;
		ouyaMod._instance = instance;
		return ouyaMod;
	}
	...
	OuyaModEditor OuyaMod::edit() const
	{
		...
		if (!_instance)
		{
			...
			return OuyaModEditor::CreateObject(0);
		}
		...
		return OuyaModEditor::CreateObject(globalRef);
	}
