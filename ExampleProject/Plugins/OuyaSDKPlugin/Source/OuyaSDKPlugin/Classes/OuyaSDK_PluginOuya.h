...
namespace OuyaSDK
{
	...
	public:
		...
		static void contentDelete(const tv_ouya_console_api_content_OuyaMod::OuyaMod& ouyaMod, CallbacksContentDelete* callbacks);

		static void contentDownload(const tv_ouya_console_api_content_OuyaMod::OuyaMod& ouyaMod, CallbacksContentDownload* callbacks);

		static void contentPublish(const tv_ouya_console_api_content_OuyaMod::OuyaMod& ouyaMod, CallbacksContentPublish* callbacks);

		static void contentUnpublish(const tv_ouya_console_api_content_OuyaMod::OuyaMod& ouyaMod, CallbacksContentUnpublish* callbacks);
		...
		static void saveOuyaMod(const tv_ouya_console_api_content_OuyaModEditor::OuyaModEditor& ouyaModEditor,
			const tv_ouya_console_api_content_OuyaMod::OuyaMod& ouyaMod,
